...
- Vendored copy for static deploy: `vendor/cipherware-kit/cipherware.css` (kit `0.2.2`)
...
- Phone-first marketing layout in `styles.css` (`max-width: 719px`); home has mobile Call CTA
